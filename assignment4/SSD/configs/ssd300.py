...
train = dict(
    ...
    log_interval=20,
    seed=0,
    epochs=60, # 4a 50, but 20 would have been enough
...
anchors = L(AnchorBoxes)(
    ...
    min_sizes=[[10, 10], [30, 30], [111, 111], [162, 162], [213, 213], [264, 264], [315, 315]], #4a [30, 30], [60, 60] "first 2"
...
optimizer = L(torch.optim.SGD)(
    ...
    lr=3e-3, momentum=0.9, weight_decay=0.0005 #lr=5e-3 
)
schedulers = dict(
