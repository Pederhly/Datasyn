...
if __name__ == "__main__":
    ...
    plt.subplot(1, 2, 1)
    utils.plot_loss(train_history_no["loss"], "Task 2 Model", npoints_to_average=10)
    utils.plot_loss(train_history_yes["loss"], "With improved sigmoid, weight and momentum", npoints_to_average=10)
    plt.ylim([0, .4])
    plt.subplot(1, 2, 2)
    plt.ylim([0.85, .99])
    utils.plot_loss(val_history_no["accuracy"], "Task 2 Model")
    utils.plot_loss(val_history_yes["accuracy"], "With improved sigmoid, weight and momentum")
